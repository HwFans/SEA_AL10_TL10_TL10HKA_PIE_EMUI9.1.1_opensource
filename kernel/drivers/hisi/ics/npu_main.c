...
static long npu_set_report_statistic(unsigned long arg)
{
    ...
    if (copy_from_user(&smmu_stat, (void __user *)(uintptr_t)arg, sizeof(smmu_stat))) {
...
static int __init npu_module_init(void)
{
    ...
    if (ret != 0) {
        NPU_ERR("platform_driver_register npu_driver err!\n");
        return ret;
    }
    ...
    if (ret != 0) {
        ...
        NPU_ERR("platform_device_register npu_device_core0 err!\n");
        return ret;
    }
    ...
    if (ret != 0) {
        ...
        platform_driver_unregister(&npu_driver);
        NPU_ERR("platform_driver_register npu_driver_core0 err!\n");
        return ret;
    }
    ...
    if (ret != 0) {
        ...
        platform_device_unregister(&npu_device_core0);
        platform_driver_unregister(&npu_driver);
        NPU_ERR("platform_device_register npu_device_core1 err!\n");
        return ret;
    }
    ...
    if (ret != 0) {
        ...
        platform_device_unregister(&npu_device_core0);
        platform_driver_unregister(&npu_driver);
        NPU_ERR("platform_driver_register npu_driver_core1 err!\n");
        return ret;
    }
